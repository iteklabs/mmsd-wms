...
router.get("/preview/:id", auth , async (req, res) => {
    try {
        ...
        // const results = [];
        // async function fetchStockData(value, prod_name) {
        //     const stock_data = await warehouse.aggregate([
        //         {
        //             $match: { 
        //                 "name": user_id.warehouse_name,
        ...
        //         {
        //             $match: {
        //                 "product_details.product_name": prod_name
        //             }
        //         },
        //         {
        //             $group: {
        ...
        //     if (!results.some(result => JSON.stringify(result) === JSON.stringify(stock_data))) {
        //         results.push(stock_data);
        //       }
        ...
        // const promises = RoomAll.map((value) => fetchStockData(value.room_name, value.product_name));
...
router.post("/preview/:id", auth , async (req, res) => {
    try {
        ...
        // const warehouse_data = await warehouse.findOne({ name: warehouse_name, room: room, warehouse_category: "Raw Materials"  });

        // res.json({ warehouse: warehouse_data, sales: new_sales })
        // return
...
router.post("/view/:id", auth , async (req, res) => {
    try {
        ...
        const new_warehouse_data = await warehouse.findOne({ name: warehouse_name, room: room });
